...
<tr>
    ...
    <td><?php echo $row['nom_computador']; ?></td>
    <td><?php echo $row['est_computador']; ?></td>
    <td><?php echo $row['hor_computador']; ?></td>
</tr>
...
<br>	<div class="agile-about w3ls-section text-center" id="about">
		<div class="container">
			<h3 class="agileits-title">Pedir computador</h3>

	

<form action= pidacompu.php method="post" class="w3-search-box">
			


			<label class="header">Ingrese el ID de el computador a pedir</label>
			<input placeholder="Id" name="id" type="text" required="">

						<label class="header">Ingrese la hora a la que entregará el computador</label>
