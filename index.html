...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
							<button onclick="location.href='Estudiantes.php'" class="btn-primary btn">Estudiantes</button>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='Clases.php'"   class="btn-primary btn">Clases</button>
	...
	<img src = "https://storage.googleapis.com/autoschool/Auto-School-800x800.jpg" >				</div>
<br>
<br>
<br>
<br>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Inicio
											<img src = "https://storage.googleapis.com/autoschool/descarga.png" width="50px" height="50px" >	
										</div></a></li>
