		...
		<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='Buscarfecha.php'"class="btn-primary btn">Buscar por Fecha</button>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='Buscarestudiante.php'"class="btn-primary btn">Buscar por Estudiante</button>
