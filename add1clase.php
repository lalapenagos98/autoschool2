...
<?php 
  ...
  $consulta=ConsultarProducto($_POST['Id']); 
...
<h1>
	...
	<div class="main-content-agile">
		<div class="sub-main-w3">
			<form action="add2clase.php" method="post">
				<div class="form-style-agile">




					<input  name="Id" type="hidden" value="<?php echo $consulta[0] ?>">

					<label>Nombre del estudiante</label>
					<input  name="Nombre" type="text" required="" value="<?php echo $consulta[4] ?>">
				</div>
				<div class="w3layouts-grids">
					<div class="form-style-agile form-grids-w3l">
						<label>Fecha de clase</label>
						<input placeholder="Fecha de clase" name="Fecha" type="date" required="">
					</div>
					<div class="form-style-agile form-grids-w3l">
				...
				<div class="w3layouts-grids">
					<div class="form-style-agile form-grids-w3l">
						<label>Vehiculo para clase</label>
						<input placeholder="Vehiculo clase" name="Vehi" type="text" required="" >
					</div>
					<div class="form-style-agile form-grids-w3l">
						<label>Profesor para clase</label>
						<input placeholder="Profesor" name="Profe" type="text" required="">
					</div>
				</div>		
					...
					<div class="form-style-agile form-grids-w3l">
						...
						<input  name="Direc" type="text" required="" value="<?php echo $consulta[1] ?>" >
					</div>
					<div class="form-style-agile form-grids-w3l">
						<label>Barrio</label>
						<input  name="Barrio" type="text" required="" value="<?php echo $consulta[2] ?>">
					</div>
				</div>	
					...
					<div class="form-style-agile form-grids-w3l">
						<label>Celular</label>
						<input  name="Cel" type="text" required="" value="<?php echo $consulta[3] ?>" >
					</div>
