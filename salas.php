             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="index.html">UNIEMPRESARIAL</a></h1>
							</div>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Inicio</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="inbox.php"><i class="fa fa-envelope nav_icon"></i><span>Consulta de usuarios</span><div class="clearfix"></div></a></li>
									<li><a href="gallery.php"><i class="fa fa-picture-o" aria-hidden="true"></i><span>Borrar usuarios</span><div class="clearfix"></div></a></li>
