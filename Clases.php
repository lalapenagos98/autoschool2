		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
							<button onclick="location.href='addclase.php'"class="btn-primary btn">Agendar clase</button>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='verclase.php'"class="btn-primary btn">Ver clases</button>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='Buscarpor.php'"class="btn-primary btn">Buscar por:</button>
