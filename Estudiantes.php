...
<html>
<head>
<title>Estudianates Autoschool</title>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
							<button onclick="location.href='addestudiante.php'"class="btn-primary btn">Nuevo estudiante</button>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
						<button onclick="location.href='verestudiantes.php'"class="btn-primary btn">Ver estudiantes</button>
...
<!-- Bootstrap Core JavaScript -->
   <script src="js/bootstrap.min.js"></script>Cl
   <!-- /Bootstrap Core JavaScript -->	   
<!-- candlestick -->
